package com.example.posterlifeapp.editor;
...
import com.example.posterlifeapp.editor.tools.EditingToolsAdapter;
import com.example.posterlifeapp.editor.tools.ToolType;
...
import static com.example.posterlifeapp.editor.FileSaveHelper.isSdkHigherThan28;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    private final EditingToolsAdapter mEditingToolsAdapter = new EditingToolsAdapter((EditingToolsAdapter.OnItemSelected) this);
...
//    }
    ...
    public void onColorChanged(int colorCode) {
        ...
        mTxtCurrentTool.setText("brush");
    }

    @Override
    public void onOpacityChanged(int opacity) {
        mPhotoEditor.setShape(mShapeBuilder.withShapeOpacity(opacity));
        mTxtCurrentTool.setText("brush2");
    }

    @Override
    public void onShapeSizeChanged(int shapeSize) {
        mPhotoEditor.setShape(mShapeBuilder.withShapeSize(shapeSize));
        mTxtCurrentTool.setText("brush3");
    }
...
//    }
    ...
    private void showSaveDialog() {
        ...
        builder.setMessage("are you sure you want to exit without saveing the image?");
